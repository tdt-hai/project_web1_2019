                            ...
                            <div class="card card-primary card-outline">
                                <div class="card-body box-profile">
                                    <div class="text-center">
                                        <img class="profile-user-img img-fluid img-circle" src="<?php echo 'data:image/jpeg;base64,' . base64_encode($users['profilePicture']); ?>" alt="User profile picture">
                                    </div>
                                    ...
                                    <h6 class="text-muted"><strong>Số điện thoại :</strong> <?php echo $users['phoneNumber']; ?> </h6>
                                    <h6 class="text-muted"> <strong>Email:</strong> <a href="mailto:<?php echo $users['email']; ?>" target="_blank"><?php echo $users['email']; ?></a>
                                    <ul class="list-group list-group-unbordered mb-3">
                                        <li class="list-group-item">
                                            <b>Friends</b> <a class="float-right"><?php echo count($friends); ?></a>
                                        </li>
                                    </ul>
                                    ...
                                    <form action="friend.php" method="POST">
                                        ...
                                        <?php elseif ($norelationship) : ?>
                                            <input type="submit" class="btn btn-success btn-block" name="action" value="Gửi yêu cầu kết bạn">
                                        <?php else : ?>
                                            <?php if (!$isrequesting) : ?>
                                                <input type="submit" class="btn btn-primary btn-block" name="action" value="Đồng ý yêu cầu kết bạn">
                                            <?php endif; ?>
                                            <input type="submit" class="btn btn-warning btn-block" name="action" value="Hủy yêu cầu kết bạn">
                                    </form>
                                <?php endif; ?>
                                <?php endif; ?>
                                </div>
                                                    ...
                                                    <form method="POST">
                                                        <div class="post">
                                                            <div class="user-block">
                                                                <img class="img-circle img-bordered-sm"  src="<?php echo 'data:image/jpeg;base64,' . base64_encode($post['profilePicture']); ?>" alt="user image">
                                                                <span class="username">
                                                                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"><?php echo $post['firstname'] . ' ' . $post['lastname']; ?></a>
                                                                    <ul class="dropdown-menu">
                                                                        <li><a href="#"><i class="fas fa-globe-americas"></i> <span>public</span></a></li>
                                                                        <li><a href="#"><i class="fas fa-user-friends"></i> <span>Friend</span></a></li>
                                                                        <li><a href="#"><i class="fas fa-lock"></i> <span>private</span></a></li>
                                                                    </ul>
                                                                        <?php
                                                                        ...
                                                                        ?>
                                                                        <?php if ($currentUser['id'] == $users['id']){?>
                                                                            <button type= "submit" name="delete" value="<?php echo $post['postID'] ?>" class="float-right btn-tool"><i class="fas fa-times"></i></button>
                                                                    <?php }?>        
                                                                </span>
                                                                <span class="description">Đăng lúc: <?php echo $post['post_time']; ?></span>
                                                            </div>
                                                            <!-- /.user-block -->
                                                            <p>
                                                            ...
                                                            <p>
                                                                <a href="#" class="link-black text-sm mr-2"><i class="far fa-thumbs-up mr-1"></i>Thích</a>
                                                                <a href="#" class="link-black text-sm"><i class="fas fa-share mr-1"></i> Chia sẻ</a>
