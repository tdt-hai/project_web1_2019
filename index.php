            ...
            <div class="panel-body">
                ...
                <ul>
                        ...
                        <?php foreach ($Suggestion as $S) : ?>
                            ...
                            <li>
                                <a href="information.php?id=<?php echo $S['id']; ?>"><?php echo $S['firstname'];echo $S['lastname']; ?></a>
                            </li>  
                           <?php } ?>
                        <?php endforeach; ?>
                </ul>
                    ...
                    <div class="card" style="margin-bottom: 10px;">
                        <div class="card-body">
                            <h5 class="card-title">
                                ...
                                <a href="information.php?id=<?php echo $post['id']; ?>"><?php echo $post['firstname'] . ' ' . $post['lastname']; ?> </a>
                            </h5>
                            <p class="card-text">
